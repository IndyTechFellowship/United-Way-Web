  ...
  render() {
    return (
      <div style={socialLoginStyle} >
        <RaisedButton style={raisedButtonStyle} label="Login with LinkedIn" />
        <RaisedButton style={raisedButtonStyle} label="Login with Facebook" />
        <GoogleSignInButton onClick={this.googleSignIn}/>
      </div>
    )
  }
...
class GoogleSignInButton extends Component {
  render() {
    return (
      <div>
        <img src="google.png" style={raisedButtonStyle} />
      </div>
    )
  }
}
